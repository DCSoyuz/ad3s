        ...
        implements CaretListener, DocumentListener, PropertyChangeListener
{
    ...
    public void setLineNumberOffset(long offset) {
        if (this.lineNumberOffset != offset) {
    ...
    private void setPreferredWidth()
    {
        ...
        long maxLineNum = lineNumberOffset + lines - 1;
        int digits = Math.max(String.valueOf(maxLineNum).length(), minimumDisplayDigits);
    ...
    protected String getTextLineNumber(int rowStartOffset)
    {
        ...
        if (line.getStartOffset() == rowStartOffset)
                return String.valueOf(lineNumberOffset + index);
        else
            return "";
    }
     ...
     */
    public int getOffsetX(int availableWidth, int stringWidth)
    {
